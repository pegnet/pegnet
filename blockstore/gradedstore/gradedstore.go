...
// GradedOPRBlockStore is where we store the graded oprblocks
type GradedOPRBlockStore struct {
	DB database.IDatabase
}

func NewGradedOPRBlockStore(db database.IDatabase) *GradedOPRBlockStore {
	o := new(OPRBlockStore)
...
func (d *GradedOPRBlockStore) Close() error {
	return d.DB.Close()
}
...
func (d *GradedOPRBlockStore) WriteInvalidOPRBlock(dbht int32) error {
...
func (d *GradedOPRBlockStore) WriteOPRBlock(opr *OprBlock) error {
...
func (d *GradedOPRBlockStore) WriteOPRBlockHead(opr *OprBlock) error {
...
func (d *GradedOPRBlockStore) FetchPreviousOPRHeight(height int32) (int32, error) {
...
func (d *GradedOPRBlockStore) FetchOPRBlockHead() (*OprBlock, error) {
	obj := new(OprBlock)
...
func (d *GradedOPRBlockStore) FetchOPRBlock(height int32) (*OprBlock, error) {
	obj := new(OprBlock)
