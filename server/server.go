...
func apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	// handle any decoder error and log
  ...
  case "chainid":
	...
	case "leaderheight":
		response(w, Result{LeaderHeight: getLeaderHeight()})
...
func invalidParameterError(w http.ResponseWriter) {
